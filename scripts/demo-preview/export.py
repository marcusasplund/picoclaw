...
def main():
    if len(sys.argv) != 4:
        raise SystemExit('Usage: export.py RELEASE-REPORT.json SOLID-REPORT.json NEW-IMAGE.tar.gz')
    ...
    export(Path(sys.argv[2]), target.parent / 'demo-frontend.json')
