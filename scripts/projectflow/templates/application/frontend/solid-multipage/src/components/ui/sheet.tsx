...
const SheetOverlay = <T extends ValidComponent = "div">(
  ...
  return (
    <SheetPrimitive.Overlay
      class={cn(
        "fixed inset-0 z-50 bg-black/45 backdrop-blur-[1px] data-[expanded=]:animate-in data-[closed=]:animate-out data-[closed=]:fade-out-0 data-[expanded=]:fade-in-0",
        local.class
      )}
      {...others}
    />
...
const SheetTitle = <T extends ValidComponent = "h2">(
  ...
  return (
    <SheetPrimitive.Title
      class={cn("text-lg font-normal tracking-wide font-heading text-foreground", local.class)}
      {...others}
    />
  )
}
